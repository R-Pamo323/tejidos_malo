  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<RouteBloc, RouteState>(
      listener: (context, state) {
        if (state is CustomOrderState) {
          Navigator.of(context).pushNamed('/customOrder');
        }
      },
      child: SafeArea(
        top: false,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Size",
                          style: MyStyles.instance.black18W500Outfit,
                        ),
                        const SizedBox(height: 20),
                              ...
                              children: List.generate(sizes.length, (index) {
                                ...
                                return InkWell(
                                  onTap: () {
                                    ...
                                    print(
                                      "Estoy imprimiendo $index y el selected es: $isSelected",
                                    );
                                  },
                        ...
                        ButtonWidget(
                          onTap: () {
                            context.read<RouteBloc>().add(GoToCustomOrder());
                          },
